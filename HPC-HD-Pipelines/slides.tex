...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item Bioinformatics algorithm for sequence alignment
      \item Encodes OCR text into protein-like sequences
      \item Comparing every document against the entire corpus
      \item Aligns sequences and returns offsets in document 
    \end{itemize}
    \item Raw Data
    \begin{itemize}
...
\begin{frame}
  ...
  \begin{center}
    ...
    \begin{tikzpicture}
      \node[label=above:{Extraction and Processing}] at (0,0) (spark) {\includegraphics[width=0.2\textwidth,clip,trim={0 0 0 4.5cm}]{images/Apache_Spark_logo.pdf}};
