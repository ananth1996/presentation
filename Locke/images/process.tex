...
\begin{tikzpicture}[node distance=1.5cm, auto]
    ...
    \node [block,onslide=<2->{dim}, above right=1cm of sort] (uniqblast) {Unique BLAST hits};
    \node [block,onslide=<2->{dim}, below right=1cm of sort] (uniqsem) {Unique Semantic hits};
